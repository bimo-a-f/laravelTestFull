...
<head>
    ...
    <title><?php echo e(config('app.name', 'KTPM')); ?></title>
    ...
    <script src="<?php echo e(asset('js/jquery.datetimepicker.js')); ?>" defer></script>
    <script src="<?php echo e(asset('js/datatables.min.js')); ?>" defer></script>
    <script src="<?php echo e(asset('js/mo.js')); ?>" defer></script>
    ...
    <link href="<?php echo e(asset('css/mo.css')); ?>" rel="stylesheet">
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><?php echo e(config('app.name', 'KTPM')); ?></a>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <?php $user = Auth::user(); if ($user->access_type == 1) { ?> 
                                    <a class="dropdown-item" href="<?php echo e(url('/user')); ?>">USERS</a> 
                                <?php } ?>
